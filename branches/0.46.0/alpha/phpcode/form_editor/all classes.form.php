...
$img = wb_load_image('C:\@desenv\WinBinder\@Privado\Projects\form_editor/resources/symb_imagebutton.bmp');
...
wb_create_control($winmain, Label, 'Label7', 10, 50, 100, 15, IDC_LABEL1007, 0x00000000, 0, 0);
...
wb_create_control($winmain, Frame, 'Frame10', 10, 75, 280, 130, IDC_FRAME1010, 0x00000000, 0, 0);
